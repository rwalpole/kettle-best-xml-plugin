...
public class CanonicalStep extends BaseStep implements StepInterface {
    ...
    private String canonicalize(Document document, CanonicalStepData data) throws KettleException {
        try{
            final byte[] canonXmlBytes = data.getCanonicalizer().canonicalizeSubtree(document);
